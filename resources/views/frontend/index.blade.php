                            ...
                            <div class="row gy-0 gx-5">
                                ...
                                <div class="col-xl-7 animated fadeInLeft">
                                    <div class="text-sm-center text-md-end">
                                        ...
                                        <h1 class="display-4 text-uppercase text-white mb-4">Gain hands-on experience in coding and advance your Digital skills.</h1>
        ...
        <div class="container-fluid service pb-5">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    ...
                    <p class="mb-0">We implement Full Stack Web Development, Digital Literacy, AI, Word Press and Business English courses.
                </div>
                <div class="row g-4">
        ...
        <div class="container-fluid blog pb-5">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    ...
                    <p class="mb-0">Our programs include a variety of workshops designed to equip students with digital knowledge, career readiness skills, and effective interview preparation.
                    </p>
                </div>
