        ...
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item">
                   ...
                   <div class="d-flex">
    @if($footer->facebook)
    <a class="btn btn-primary btn-sm-square rounded-circle me-3" href="{{ $footer->facebook }}"><i class="fab fa-facebook-f text-white"></i></a>
    @else
    <span class="text-white">N/A</span>
    @endif

    @if($footer->twitter)
    <a class="btn btn-primary btn-sm-square rounded-circle me-3" href="{{ $footer->twitter }}"><i class="fab fa-twitter text-white"></i></a>
    @else
    <span class="text-white">N/A</span>
    @endif

    @if($footer->instagram)
    <a class="btn btn-primary btn-sm-square rounded-circle me-3" href="{{ $footer->instagram }}"><i class="fab fa-instagram text-white"></i></a>
    @else
    <span class="text-white">N/A</span>
    @endif

    @if($footer->linkedin)
    <a class="btn btn-primary btn-sm-square rounded-circle me-0" href="{{ $footer->linkedin }}"><i class="fab fa-linkedin-in text-white"></i></a>
    @else
    <span class="text-white">N/A</span>
    @endif
</div>
