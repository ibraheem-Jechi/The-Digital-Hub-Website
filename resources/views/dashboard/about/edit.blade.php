...
<head>
    ...
    <title>Edit About | Dashboard</title>
        ...
        <main class="flex-1 p-6">
            <div class="max-w-4xl mx-auto">
                <div class="bg-white p-8 rounded-xl shadow-md">
                    <h1 class="text-2xl font-bold mb-6 text-gray-800">Edit About Section</h1>
                    ...
                    <form action="{{ route('about.update', $about->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4"
                                class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-indigo-300">{{ old('description', $about->description) }}</textarea>
                        </div>
                        ...
                        <div class="pt-4 border-t">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <input type="text" name="feature_1_icon" placeholder="Icon class"
                                    value="{{ old('feature_1_icon', $about->feature_1_icon) }}"
                            ...
                            <textarea name="feature_1_description" rows="2"
                                class="mt-2 w-full border rounded-lg px-4 py-2">{{ old('feature_1_description', $about->feature_1_description) }}</textarea>
                        </div>
                        ...
                        <div class="pt-4 border-t">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <input type="text" name="feature_2_icon" placeholder="Icon class"
                                    value="{{ old('feature_2_icon', $about->feature_2_icon) }}"
                                    class="border rounded-lg px-4 py-2 w-full">
                            ...
                            <textarea name="feature_2_description" rows="2"
                                class="mt-2 w-full border rounded-lg px-4 py-2">{{ old('feature_2_description', $about->feature_2_description) }}</textarea>
                        </div>
                        ...
                        <div class="pt-4 border-t">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <input type="text" name="feature_3_icon" placeholder="Icon class"
                                    value="{{ old('feature_3_icon', $about->feature_3_icon) }}"
                                    class="border rounded-lg px-4 py-2 w-full">
                            ...
                            <textarea name="feature_3_description" rows="2"
                                class="mt-2 w-full border rounded-lg px-4 py-2">{{ old('feature_3_description', $about->feature_3_description) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            @if($about->image)
                                <img src="{{ asset('storage/' . $about->image) }}" class="w-32 h-20 object-cover mb-2 rounded shadow">
                            @endif
