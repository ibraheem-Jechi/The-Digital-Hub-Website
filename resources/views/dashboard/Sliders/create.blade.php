...
<head>
    ...
    <title>Slider Form | Dashboard</title>
                ...
                <div class="bg-white p-6 shadow-sm sm:rounded-lg mb-6">
                    ...
                    <form action="{{ route('sliders.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="subtitle" class="w-full border rounded px-3 py-2" value="{{ old('subtitle') }}">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" name="video_link" class="w-full border rounded px-3 py-2" value="{{ old('video_link') }}">
                        </div>
                        ...
                        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">Add Slider</button>
                    </form>
                </div>
            </div>
        </main>
