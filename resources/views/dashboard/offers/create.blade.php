            ...
            <aside id="sidebar" class="bg-side-nav w-1/2 md:w-1/6 lg:w-1/6 border-r border-side-nav hidden md:block lg:block">
                <ul class="list-reset flex flex-col">
                    <li class="w-full py-3 px-2 border-b ">
                        <a href="{{ url('/dashboard') }}" class="text-sm text-nav-item no-underline hover:font-bold">
                ...
                <div class="container mx-auto">
                    ...
                    <form action="{{ route('offers.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" class="w-full border px-2 py-1 rounded" value="{{ old('title') }}">
                        </div>
                        <div class="mb-4">
                            <label class="block">Subtitle</label>
                            <input type="text" name="subtitle" class="w-full border px-2 py-1 rounded" value="{{ old('subtitle') }}">
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="button_text" class="w-full border px-2 py-1 rounded" value="{{ old('button_text') }}">
                        </div>
                        <div class="mb-4">
                            <label class="block">Button Link</label>
                            <input type="text" name="button_link" class="w-full border px-2 py-1 rounded" value="{{ old('button_link') }}">
                        </div>

                        <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-700">Save Offer</button>
